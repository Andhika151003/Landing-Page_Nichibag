  ...
  return (
    <div className="pt-6">
      ...
      >
        <SplitText
          text="Nichibag.id"
          className="text-4xl font-bold mb-4 leading-[normal] align-bottom tracking-tight"
          splitType="chars"
          delay={80}
          from={{ opacity: 0, y: 40 }}
          to={{ opacity: 1, y: 0 }}
      ...
      >
        <div className="md:w-1/2">
          ...
          <p className="text-black mb-4">
            Didirikan sejak tahun 2022, Nichi Bag hadir sebagai solusi kemasan
            modern yang mengutamakan kualitas, estetika, dan kepedulian terhadap
            lingkungan. Kami fokus menyediakan paperbag dan kemasan berbahan
            dasar ramah lingkungan yang tidak hanya fungsional, tetapi juga
            meningkatkan citra produk Anda.
          </p>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            {
              title: "Berkualitas",
              desc: "Kemasan Berkualitas...",
              icon: "🎯",
            },
            {
              title: "Inovasi",
              desc: "Selalu berusaha menciptakan...",
              icon: "💡",
            },
            {
