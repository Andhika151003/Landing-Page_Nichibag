...
const Dashboard = () => {
  const collections = [
    { name: "Paper Bag", type: "Paper Bag", status: "Published", date: "2023-08-15" },
    { name: "Packaging Box", type: "Packaging Box", status: "Published", date: "2023-08-15" },
    { name: "Gift Box", type: "Gift Box", status: "Published", date: "2023-08-15" },
    { name: "Custom Box", type: "Packaging Box", status: "Draft", date: "2023-08-15" },
    { name: "Custom Bag", type: "Paper Bag", status: "Draft", date: "2023-08-15" },
  ];

  const featured = [
    { name: "Paper Bag", image: "https://source.unsplash.com/300x300/?paperbag" },
    { name: "Packaging Box", image: "https://source.unsplash.com/300x300/?packaging" },
  ...
  return (
    <div className="flex min-h-screen bg-[#fefcfc] text-[#3a2d2d]">
      ...
      <aside className="w-64 bg-[#fff9f9] shadow-md p-6 border-r">
        ...
        <p className="text-sm text-gray-500 mb-6">Selamat Datang Di Panel Admin</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featured.map((item, idx) => (
              <div key={idx} className="rounded-xl overflow-hidden shadow-sm">
                ...
                />
                <div className="p-3 text-center text-sm font-medium">{item.name}</div>
              </div>
            ))}
          </div>
        </section>
              ...
              <tbody>
                {collections.map((item, idx) => (
                  <tr key={idx} className="border-t">
                    ...
                    <td className="px-4 py-3 text-[#c66] font-medium">{item.type}</td>
